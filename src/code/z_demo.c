...
EntranceCutscene sEntranceCutsceneTable[] = {
    ...
    { 0x0053, 2, 0xA7, 0x0200CE00 }, { 0x0000, 2, 0xA8, 0x0200B640 }, { 0x028A, 0, 0x18, 0x0200F9E0 },
    ...
    { 0x0129, 2, 0xB3, 0x02006490 }, { 0x0157, 2, 0xB4, 0x02005BD0 }, { 0x0028, 2, 0xB5, 0x020155E0 },
    ...
    { 0x0538, 2, 0xBB, 0x0201E780 }, { 0x053C, 2, 0xBC, 0x0201EF60 }, { 0x0540, 2, 0xBD, 0x02021370 },
    { 0x0544, 2, 0xBE, 0x0201E3D0 }, { 0x0548, 2, 0xBF, 0x0201DF80 }, { 0x054C, 2, 0xAD, 0x0201EB30 },
...
u32 D_8011E304[] = { 0x0200B640, 0x020155E0, 0x02014F80, 0x02003F80, 0x02000250, 0x0201DA40 };
        ...
        switch (cmd->base) {
            ...
            case 113:
                if (Flags_GetEventChkInf(0xBB) && Flags_GetEventChkInf(0xBC) && Flags_GetEventChkInf(0xBD) &&
                    ...
                    globalCtx->csCtx.segment = SEGMENTED_TO_VIRTUAL(&D_0201DA40);
